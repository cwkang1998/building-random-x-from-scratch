import { encodeString, unsignedLEB128, ieee754 } from './encoding';
...
export const emitter: Emitter = (ast: Program) => {
  ...
  const exportSection = createSection(
    Section.export,
    encodeVector([[...encodeString('run'), ExportType.func, 0x01]]) // 0x01 is a function index
  );
